...
public class NfcOrderWater {
    ...
    private NfcMerch nfcMerchMerch;
	...
	public NfcMerch getNfcMerchMerch() {
		return nfcMerchMerch;
	}

	public void setNfcMerchMerch(NfcMerch nfcMerchMerch) {
		this.nfcMerchMerch = nfcMerchMerch;
	}
